...
public class ForumUsersController {
    ...
    public ForumUsersController(ForumUserService service, InterestService skillService, ForumUserRepository forumUserRepository, InterestRepository interestRepository) {
    ...
    public String showList(@RequestParam(required = false) Long interestId,@RequestParam(required = false) Integer age, Model model) {
        ...
        model.addAttribute("interests",this.interestRepository.findAll());
        return "list";
    }
    ...
    public String showEdit(@PathVariable Long id,Model model) {
        ...
        model.addAttribute("forumUser",this.forumUserRepository.findById(id).orElseThrow(InvalidForumUserIdException::new));
